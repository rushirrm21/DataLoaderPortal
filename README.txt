1. Please find the Case Study 1 Word file that contains the description/documentation of the USE CASE.
...
4 The Implemented code contains the Frontend and Backend code.
	...
	4.1 Front_End
		...
		4.1.2 Import the folder of frontend->dlportal into vs code and after successfull importing type command npm start and the application will start.
	
		4.1.3 For accessing the api please check the port number in the url given in the files. Currently its configure to run on 8080 and 8081. If you are 
	...
	4.2 Back_End
		...
		4.2.1 Import the folder Back_End->DLPortal into one workspace and Back_End->PatientInduction into another workspace into your prefferd IDE. 
			I have used Spring Tool Suite.

		4.2.2 After importing run both the application from menu Run As->Spring Boot Application.
